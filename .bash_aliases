...
alias gotoHDD='cd /media/diego/Windows'

# The ciens alias activates the conda enviroment
alias ciens='source /media/diego/Windows/anaconda3/bin/activate'
alias playminecraft='java -jar /media/diego/Windows/Users/diego/Documents/minecraft/TLauncher-2.69.jar'
